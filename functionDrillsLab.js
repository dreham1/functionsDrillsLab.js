...
//CODE HERE
// PLACE HOLDER IS THE PARAM (NAME)
...
greeting("Dre")
// THE ACTUAL VALUE PASSED IS ARGUMENT(DRE OR JAKE)
greeting("jake")
greeting(10)
...
function add (x, y){
  ...
  //return "the function is done executing";
  //console.log(op1 + op2);
  //console.log("function was called");
}

var answer = add(4,5);
var answer2 = add(10, 15);
console.log("The first answer is: " + answer + " The second answer is: " + answer2);
console.
//add(answer,answer2); 

var answeer = add(answer,answer2); 
...
console.log(winners)
// console.log(String(contestants))
